 ...
 * Component for Image output.
 * Provides a push-out port for the color image.
 */
class ImageOutput
...
public:
	 ...
	 */
	ImageOutput( const std::string& name, boost::shared_ptr< Graph::UTQLSubgraph > subgraph, 
...
protected:
	...
	boost::shared_ptr< Vision::Image > m_image;
